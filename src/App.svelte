...
<main class="app-shell">
	<section class="controls" class:filters-open={filtersOpen} aria-label="Inventory filters">
		<label class="search-field">
			<span>Search</span>
			<input bind:value={query} type="search" placeholder="Name, set, number, notes..." autocomplete="off" />
		</label>
	...
	{:else}
		...
		{#if selectedCard}
			<div class="modal-layer">
				<button class="modal-backdrop" type="button" aria-label="Close card details" on:click={closeModal}></button>
