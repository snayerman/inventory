...
<section class="detail-panel" aria-label="Selected card details">
	{#if card}
		...
		<div class="closeups">
			<figure>
				...
				{:else}
					<a class="image-link" href={card.frontImage} target="_blank" rel="noreferrer">
						<img
							src={card.frontImage}
			...
			<figure>
				...
				{:else}
					<a class="image-link" href={card.backImage} target="_blank" rel="noreferrer">
						<img
							src={card.backImage}
	...
	{:else}
		<div class="empty-detail">
			...
			<p>Use search and filters to narrow the list, then open the card you are listing.</p>
		</div>
	{/if}
</section>
